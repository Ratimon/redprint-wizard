<script lang="ts">
    ...
    import { systemConfig } from '$lib/wizard/smart-contracts';
    import { deploySystemConfig } from '$lib/wizard/deploy-scripts';
  
    const contractDefaults = systemConfig.defaults;
    const deployDefaults = deploySystemConfig.defaults;
  
    export let opts: Required<KindedSystemConfigOptions['SystemConfig'] > = {
      kind: 'SystemConfig',
      ...contractDefaults,
      ...deployDefaults,
