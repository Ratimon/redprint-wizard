<script lang="ts">
    ...
    export let opts: Required<KindedOptimismMintableERC20FactoryOptions['OptimismMintableERC20Factory'] > = {
      ...
      contractInfo: {  securityContact: 'Consult full code at https://github.com/ethereum-optimism/optimism/blob/v1.9.1/packages/contracts-bedrock/src/L1/L1CrossDomainMessenger.sol', license: 'MIT'  },
