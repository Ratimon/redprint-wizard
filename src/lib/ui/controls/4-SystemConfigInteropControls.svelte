<script lang="ts">
    ...
    import type { KindedSystemConfigOptions } from '$lib/wizard/shared';
  
    import { systemConfigInterop } from '$lib/wizard/smart-contracts';
    import { deploySystemConfigInterop } from '$lib/wizard/deploy-scripts';
  
    const contractDefaults = systemConfigInterop.defaults;
    const deployDefaults = deploySystemConfigInterop.defaults;
  
    export let opts: Required<KindedSystemConfigOptions['SystemConfigInterop'] > = {
      kind: 'SystemConfigInterop',
      ...contractDefaults,
      ...deployDefaults,
