<script lang="ts">
    ...
    export let opts: Required<KindedProxyAdminOptions['ProxyAdmin'] > = {
      ...
      contractInfo: {  securityContact: 'Consult full code at https://github.com/ethereum-optimism/optimism/blob/v1.9.4/packages/contracts-bedrock/src/universal/ProxyAdmin.sol', license: 'MIT'  },
