<script lang="ts">
    ...
    export let opts: Required<KindedL1CrossDomainMessengerOptions['L1CrossDomainMessenger'] > = {
      ...
      contractInfo: {  securityContact: 'Consult full code at https://github.com/ethereum-optimism/optimism/blob/v1.9.1/packages/contracts-bedrock/src/legacy/ResolvedDelegate.sol', license: 'MIT'  },
