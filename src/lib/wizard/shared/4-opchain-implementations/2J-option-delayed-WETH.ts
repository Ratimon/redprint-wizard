...
export const defaults: Required<SharedDelayedWETHOptions> = {
  //contract
  ...
  //deploy
  deployName: 'DeployDelayedWETHScript',

  deployInfo: commonDefaults.deployInfo,
} as const;


export interface SharedDelayedWETHOptions extends CommonOptions {
  contractName: string;
