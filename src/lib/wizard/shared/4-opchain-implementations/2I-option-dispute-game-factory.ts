...
export const defaults: Required<SharedDisputeGameFactoryOptions> = {
  //contract
  ...
  //deploy
  deployName: 'DeployDisputeGameFactoryScript',

  deployInfo: commonDefaults.deployInfo,
} as const;


export interface SharedDisputeGameFactoryOptions extends CommonOptions {
  contractName: string;
