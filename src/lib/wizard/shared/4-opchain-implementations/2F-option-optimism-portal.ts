...
export const defaults: Required<SharedOptimismPortalOptions> = {
  //contract
  ...
  //deploy
  deployName: 'DeployOptimismPortalScript',

  deployInfo: commonDefaults.deployInfo,
} as const;


export interface SharedOptimismPortalOptions extends CommonOptions {
  contractName: string;
