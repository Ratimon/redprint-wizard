...
export const defaults: Required<SharedSystemConfigOptions> = {
  //contract
  ...
  //deploy
  deployName: 'DeploySystemConfigScript',

  deployInfo: commonDefaults.deployInfo,
} as const;


export interface SharedSystemConfigOptions extends CommonOptions {
  contractName: string;
