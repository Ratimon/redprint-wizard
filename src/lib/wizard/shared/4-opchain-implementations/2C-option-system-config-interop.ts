...
export const defaults: Required<SharedSystemConfigInteropOptions> = {
  //contract
  contractName: 'SystemConfigInterop',
  ...
  //deploy
  deployName: 'DeploySystemConfigInteropScript',

  deployInfo: commonDefaults.deployInfo,
} as const;


export interface SharedSystemConfigInteropOptions extends CommonOptions {
  contractName: string;
