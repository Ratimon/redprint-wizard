...
export const defaults: Required<SharedPreimageOracleOptions> = {
  //contract
  ...
  //deploy
  deployName: 'DeployPreimageOracleScript',

  deployInfo: commonDefaults.deployInfo,
} as const;


export interface SharedPreimageOracleOptions extends CommonOptions {
  contractName: string;
