...
export const defaults: Required<SharedDataAvailabilityChallengeProxyOptions> = {
  //contract
  contractName: 'Proxy',
  ...
  //deploy
  deployName: 'DeployDataAvailabilityChallengeProxyScript',

  deployInfo: commonDefaults.deployInfo,
} as const;


export interface SharedDataAvailabilityChallengeProxyOptions extends CommonOptions {
  contractName: string;
