...
export const defaults: Required<SharedAddressManagerOptions> = {
  //contract
  ...
  //deploy
  deployName: 'DeployAddressManagerScript',

  deployInfo: commonDefaults.deployInfo
} as const;


export interface SharedAddressManagerOptions extends CommonOptions {
  contractName: string;
