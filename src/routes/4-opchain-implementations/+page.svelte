...
<WizardSingle isShowingCommand={true} conventionNumber={'402N'} initialContractTab={initialContractInitializeImplementationsTab} contractTab={contractInitializeImplementationsTab} opts={optsInitializeImplementations} deployContract={deployContractInitializeImplementations}>
  ...
  <div slot="caption" >
    ...
    <h2 class="m-4 font-extrabold	">When configuring <a class="bg-secondary underline" href="https://github.com/ethereum-optimism/docs/blob/main/pages/builders/chain-operators/configuration/rollup.mdx" target="_blank" rel="noreferrer">l2OutputOracleStartingTimestamp</a> in <a class="bg-secondary underline" href="https://github.com/ethereum-optimism/optimism/blob/72eb3116c2f6ff573099a8cafc8f35415138850c/op-chain-ops/genesis/testdata/test-deploy-config-full.json#L15" target="_blank" rel="noreferrer">genesis file</a>, dont forget to set it as lowerer than the current <span class="bg-secondary underline">blocktimestamp</span> on your environment.</h2>
